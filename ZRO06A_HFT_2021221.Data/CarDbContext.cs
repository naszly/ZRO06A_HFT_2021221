...
namespace ZRO06A_HFT_2021221.Data
{
    public abstract class CarDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var bmw1 = new Car { Id = 1, BrandId = bmw.Id, BasePrice = 20000, Model = "116d" };
            var bmw2 = new Car { Id = 2, BrandId = bmw.Id, BasePrice = 30000, Model = "510" };
            var citroen1 = new Car { Id = 3, BrandId = citroen.Id, BasePrice = 10000, Model = "C1" };
            var citroen2 = new Car { Id = 4, BrandId = citroen.Id, BasePrice = 15000, Model = "C3" };
            var audi1 = new Car { Id = 5, BrandId = audi.Id, BasePrice = 20000, Model = "A3" };
            var audi2 = new Car { Id = 6, BrandId = audi.Id, BasePrice = 25000, Model = "A4" };
